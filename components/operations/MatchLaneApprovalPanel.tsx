...
export function MatchLaneApprovalPanel({
  ...
  return (
    ...
    >
      ...
      <BottomQuartileList rows={snapshot.bottomQuartile} />
...
function BottomQuartileList({
  ...
  return (
    <section className="mt-4">
      ...
      <p className="mt-0.5 text-xs text-slate-500">
        Sorted lowest confidence first. Tap a row to see the per-field breakdown.
      </p>
              ...
              <summary className="flex cursor-pointer items-center justify-between gap-3 px-3 py-2 text-sm font-medium text-slate-800 hover:bg-slate-100">
                <span>
                  ...
                  <span className="text-xs text-slate-500">
                    · {(app.verification.overallConfidence * 100).toFixed(0)}% confidence
                  </span>
                </span>
                <span
                  aria-hidden="true"
